...
function Hotel(name, rooms, booked) {
  ...
  // Create a new hotel object (you mentioned adding a third hotel)
  ...
  var details3 = sunsetHotel.name + ' rooms: '; // Use the newly created sunsetHotel object
      details3 += sunsetHotel.checkAvailability(); // Use the checkAvailability method of sunsetHotel
